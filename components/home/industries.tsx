...
export default function Industries() {
  return (
    <section className="relative overflow-hidden py-20 px-4 md:px-6 bg-[#f4f7fb]">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-blue-200/30 blur-3xl rounded" />

      <div className="absolute bottom-0 left-0 w-96 h-96 bg-cyan-200/30 blur-3xl rounded" />
