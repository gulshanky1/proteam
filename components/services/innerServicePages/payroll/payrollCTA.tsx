      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <p
            ...
            "
          >
           PROTEAM simplifies payroll management through accurate salary processing, statutory compliance, and end-to-end payroll administration.
           Our technology-enabled solutions ensure timely payments, regulatory compliance, data confidentiality, and complete workforce payroll 
           support, allowing organizations to focus on growth with confidence.
          </p>
