      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <p
            ...
            "
          >
           PROTEAM delivers comprehensive security and risk management solutions designed to protect people, assets, and business operations. 
           Through expert investigation, background verification, corporate intelligence, and proactive risk assessment, we help organizations
           strengthen security, reduce vulnerabilities, and operate with confidence.
          </p>
