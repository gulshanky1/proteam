      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <p
            ...
            "
          >
           PROTEAM provides strategic staffing and recruitment solutions that connect organizations with qualified, reliable, and industry-ready professionals. 
           Leveraging an extensive talent network and proven hiring expertise, we support permanent recruitment, temporary staffing, project-based hiring, and
           executive search services to help businesses build high-performing teams and achieve their growth objectives.
          </p>
